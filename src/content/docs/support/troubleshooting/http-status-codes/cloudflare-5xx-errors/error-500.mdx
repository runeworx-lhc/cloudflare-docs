...
- A configuration issue on Page Rules can generate HTTP Error 500 on the Cloudflare Edge. 
See [the article under Page Rules](/rules/page-rules/troubleshooting/general/#error-500-internal-server-error) for more details and resolution.
