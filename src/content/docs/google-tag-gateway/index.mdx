...
Site owners can enable this feature in one of two ways: through the Google tag console, or via the Cloudflare dashboard. 

### Configure Google tag gateway for advertisers in the Google tag console
Setting this up [directly in Google Tag Manager](https://support.google.com/analytics/answer/16061641) is the fastest way to use this feature.
