...
Triggered when an object was uploaded.

**Example:**

```json
{
  "type": "cf.r2.bucket.object.uploaded",
  "source": {
    "type": "r2.bucket",
...
Triggered when an object was deleted.

**Example:**

```json
{
  "type": "cf.r2.bucket.object.deleted",
  "source": {
    "type": "r2.bucket",
    "bucketName": "my-bucket"
  },
...
Triggered when a vector was created.

**Example:**

```json
{
  "type": "cf.vectorize.index.vector.created",
  "source": {
...
Triggered when a key was created.

**Example:**

```json
{
  "type": "cf.kv.namespace.key.created",
  "source": {
    "type": "kv.namespace",
    "namespaceId": "ns-12345678-90ab-cdef-1234-567890abcdef"
  },
  "payload": {
    "key": "user:12345"
  },
...
Triggered when a key was updated.

**Example:**

```json
{
  "type": "cf.kv.namespace.key.updated",
  "source": {
    "type": "kv.namespace",
    "namespaceId": "ns-12345678-90ab-cdef-1234-567890abcdef"
  },
...
Triggered when a key was deleted.

**Example:**

```json
{
  "type": "cf.kv.namespace.key.deleted",
  "source": {
    "type": "kv.namespace",
    "namespaceId": "ns-12345678-90ab-cdef-1234-567890abcdef"
  },
...
```json
{
  "type": "cf.workflows.workflow.created",
  "source": {
    "type": "workflows"
  },
  "payload": {
